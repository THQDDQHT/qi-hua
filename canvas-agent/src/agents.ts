...
class CodexAppClient {
    ...
    static async start(emit: AgentEmit) {
        ...
        await client.request("initialize", { clientInfo: { name: "canvas-agent", title: "啟画本地 Agent", version: VERSION }, capabilities: { experimentalApi: true, requestAttestation: false } });
