<p align="center">
  <img src="web/public/logo.svg" width="96" alt="啟画 logo">
</p>

<h1 align="center">啟画 (infinite-canvas)</h1>
...
啟画是一款面向图片创作的开源无限画布工作台。它把画布编排、AI 图片生成、参考图编辑、对话助手、提示词库和素材沉淀放在同一个界面里，适合用来探索视觉方案并连续迭代图片结果。
